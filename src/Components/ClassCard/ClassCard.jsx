...
const ClassCard = ({cls}) => {
    return (
        <div  className="">
                <div key={cls.serialNumber}  className={` card  hover:shadow-7xl hover:rounded-sm hover:shadow-slate-700 rounded-none w-[400px] mx-auto xl:w-[400px] md:w-[360px] h-[450px] bg-base-100 shadow-xl ${cls.availableSeats <1 && 'bg-red-500 text-white'}`}>
